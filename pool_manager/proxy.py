        ...
        try:
                    ...
                    while b"\n\n" in buf:
                        ...
                        if ev.startswith("data: "):
                            try:
                                ...
                                elif _reasoning_buf and '[CLASS' in _reasoning_buf and content:
                                    pass
            ...
            if start_time > 0:
                ...
                if not topic and _reasoning_buf:
                    from pool_manager.analytics import infer_topic_from_text
                    topic = infer_topic_from_text(_reasoning_buf)
                if not topic:
                    topic = ""
